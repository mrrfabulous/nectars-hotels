      ...
      html: `
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
          <div style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); padding: 30px; text-align: center;">
            <img 
                src="https://www.nectarhotelsandsuites.com/_next/image?url=%2Fimages%2FUpdate%20Nectar%20Hotels.png&w=1920&q=75" 
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
          <div style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); padding: 30px; text-align: center;">
           <img 
    src="https://nectarhotelsandsuites.com/logo.png" 
    alt="Nectar Hotels & Suites" 
    style="width: 100%; max-width: 180px; height: auto; margin-bottom: 10px;"
  />
            <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: bold;">
