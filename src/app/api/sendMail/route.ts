          ...
          <div style="padding:30px;">
            ...
            <div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:20px;margin:25px 0;">
              ...
              <div style="color:#374151;">
                ...
                <p style="margin:8px 0;"><strong>Email:</strong> <a href="mailto:${hotelContact.email}" style="color:#3b82f6;">${hotelContact.email}</a></p>
              </div>
            </div>
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            `Email configuration error. Please reach us on WhatsApp or call ${hotelContact.phoneDisplay}.`,
        },
        { status: 500 }
      );
    }
    ...
    return NextResponse.json(
      {
        success: false,
        message:
          `Failed to send message. Please try again or contact us on WhatsApp or call ${hotelContact.phoneDisplay}.`,
      },
      { status: 500 }
    );
  }
