...
import { Star, Wifi, Car, Utensils, Waves, Award, Badge, Heart, ArrowRight } from 'lucide-react';
...
export default function Home() {
  const features = [
    { icon: <Wifi className="h-8 w-8" />, title: 'Free Wi-Fi', description: 'High-speed internet throughout the hotel' },
    { icon: <Car className="h-8 w-8" />, title: 'Valet Parking', description: 'Complimentary parking service' },
    { icon: <Utensils className="h-8 w-8" />, title: 'Fine Dining', description: 'One of the best restaurants' },
    { icon: <Waves className="h-8 w-8" />, title: 'Luxury Spa', description: 'Classic spa and wellness center' },
  ];
    ...
    <div className="">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center">
        <div
          ...
          style={{
            backgroundImage: 'url(/images/breakfast-portrait.jpg)'
          }}
        >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Discover the perfect blend of luxury, comfort, and personalized service
            </motion.p>
          </motion.div>
