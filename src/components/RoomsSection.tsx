        ...
        >
          {rooms.map((room, index) => (
            <motion.div 
              ...
              className={`
                ${room.size === 'large' ? 'md:col-span-6 md:row-span-2' : 'md:col-span-6'} 
              ...
              <div 
                ...
                style={{
                  backgroundImage: `linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-${
                    index === 0 ? '1584132967334-10e028bd69f7' :
                    index === 1 ? '1571003123894-1f0594d2b5d9' :
                    index === 2 ? '1566665797739-1674de7a421a' :
                    index === 3 ? '1582719478250-c89cae4dc85b' :
                    index === 4 ? '1582719478250-c89cae4dc85b' :
                    '1584132967334-10e028bd69f7'
                  }?ixlib=rb-4.0.3')`
                }}
              />
              <div className={`absolute inset-0 ${room.size === 'large' ? 'p-8' : 'p-6'} flex flex-col justify-end text-white`}>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
