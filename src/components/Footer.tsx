        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-blue-100 mb-4 leading-relaxed">
              Experience unparalleled luxury and comfort at Nectar Hotel and Suites. 
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-blue-100">nectarhotelsandsuites@gmail.com</span>
              </div>
              ...
              <span className="text-blue-100 capitalize leading-relaxed">
                No.5, Tilde Street, Near Albarka Radio Station, Off Sunday Awoniyi Road,
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/rooms" className="text-blue-100 hover:text-amber-500 transition-colors">Rooms & Suites</a></li>
              <li><a href="/gallery" className="text-blue-100 hover:text-amber-500 transition-colors">Gallery</a></li>
              <li><a href="/about" className="text-blue-100 hover:text-amber-500 transition-colors">About Us</a></li>
              <li><a href="/contact" className="text-blue-100 hover:text-amber-500 transition-colors">Contact</a></li>
            </ul>
          </div>
        </div>
